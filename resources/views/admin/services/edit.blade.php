                ...
                <div class="p-8">
                    <form method="POST" action="{{ route('admin.services.update', $service->id) }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="titre" name="titre" value="{{ old('titre', $service->titre) }}" 
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" id="prix" name="prix" value="{{ old('prix', $service->prix) }}" step="0.01" min="0"
                            ...
                            <div>
                                ...
                                <input type="number" id="duree" name="duree" value="{{ old('duree', $service->duree) }}" min="1"
                        ...
                        <div>
                            ...
                            <select id="medecin_id" name="medecin_id" 
                                ...
                                @foreach($medecins as $medecin)
                                    <option value="{{ $medecin->id }}" {{ old('medecin_id', $service->medecin_id) == $medecin->id ? 'selected' : '' }}>
                                        {{ $medecin->name }}
                                    </option>
                                @endforeach
                            </select>
